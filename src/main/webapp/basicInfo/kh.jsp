...
<head>
    ...
    <title>客户</title>
    <script src="${ctx}/js/basicInfo/js/kh.js"></script>
</head>
<body>
<%--搜索框--%>
<label>名称</label>
...
<a class="layui-btn layui-icon " id="searchkh_btn" data-type="reload">&nbsp;搜索</a>

<table class="layui-hide" id="supplier" lay-filter="supplier"></table>

<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <a class="layui-btn layui-btn-sm" lay-event="addkh">增加</a>
    </div>
</script>

<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs" lay-event="editkh">编辑</a>
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delkh">删除</a>
</script>
